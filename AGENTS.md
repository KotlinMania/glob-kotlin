...
This file is the quick-reference operating contract for glob-kotlin. The longer
...
glob-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`glob`](https://crates.io/crates/glob). Upstream Rust is the behavioral oracle while the

...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Glob.swiftmodule/`
...
//      `import Glob` above would fail at compile time.
//
//   2. The static archive `libGlob.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Glob" }` and
//      `flattenPackage = "io.github.kotlinmania.glob"` configuration in
